...
morgan.format('oma', ":method :url :status :res[content-length] - :response-time ms :req-body")
...
morgan.format('tiny2', ':method :url :status :res[content-length] - :response-time ms :req[body]')
